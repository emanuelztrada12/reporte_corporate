    ...
    <div class="panel-body">
        ...
        <table id="tbllistado" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                ...
                <th class="select-filter">VP</th>
                <th class="select-filter">Total de usuarios</th>
                <th class="select-filter">% Cumplimiento</th>
                <th class="select-filter">Usuarios que finalizaron el curso</th>
                <th class="select-filter">% Pendientes</th>
                <th class="select-filter">Total de usuarios pendientes</th>
                <th class="select-filter">visualizar curso</th>
                <!-- <th class="select-filter">Usuario</th> -->
...
if (rol1 == 'icasa-individual') {
    ...
    url1 = '../ajax/reporte2.php';
    grafica = '../ajax/grafica2.php';

} else if (rol2 = 1 || rol3 == 'icasa-completo') {

    url1 = '../ajax/reporte1.php';
    grafica = '../ajax/grafica.php';
...
jQuery(document).ready(function($) {
    ...
    jQuery('#mostrar').click(function() {
        ...
        $('#graph').load(
            `${grafica}?curso=${curso}&fecha_inicio=${fecha_inicio}&fecha_fin=${fecha_fin}&vp=${vp}`
        );
